        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MoviesAsActorActress = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    MoviesAsDirector = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    MoviesAsProducer = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
